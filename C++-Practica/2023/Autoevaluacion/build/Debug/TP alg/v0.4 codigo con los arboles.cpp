...
int transporte(int v); //Funcion que devuelve un entero de 0-3 (que corresponde al vehiculo), a partir del volumen del pedido
...
infopedido desencolarpedido(colapedidos matrizpedidos[14][4], int zona, int mediodetransporte){
infopedido pedido;
//Poner codigo para que desencole el pedido (Jhordan)
//Tener en cuenta que se devuelve el struct infopedido
return pedido;
}
