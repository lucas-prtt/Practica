...
def isFilled(x, y):
    return not outOfBounds(x, y) and (rollsMap[x][y] == "@" or rollsMap[x][y] == "!")
...
removedTotal = 0
while(True): # Puede que haya una mejor manera. Esto es tipo "Fuerza bruta"
    removedThisRound = executeCleanup()
